...
class GraphComp:
    ...
    def Create_Bipartite_Giant_Component(self, grp, file_name='data/movies.txt', n_movies=40000, prs_out='dictionary'):
        ...
        print('Calculation time-Create graph from the movies file: {}'.format(end_time-start_time))
    ...
    def similarity_check_vector(self, R, max_connected_gr_amazon_movies, movie_indexes, ref_user_idx, node_list, top_similarity=40):
        ...
        return df_summary, movie_list_ref, movie_by_reference_user
    ...
    def similarity_check_vector_VAL(self, R, movie_indexes, ref_user_idx, node_list, node_list_v, movie_FOR_reference_user, max_connected_gr_amazon_movies, max_connected_gr_amazon_movies_v, top_similarity=40):
        ...
        for u_idx in user_similarity_top_non_zero:
            ...
            for m in movie_list_ref:
                ...
                try:
                    scr_new = max_connected_gr_amazon_movies.get_edge_data_v(user_name, m)['weight']
                except:
                ...
                try:
                    review_count_new = len(list(max_connected_gr_amazon_movies.edges_v([m])))
                except:
                    review_count_new = 0
        ...
        return df_summary, movie_list_ref, movie_FOR_reference_user
