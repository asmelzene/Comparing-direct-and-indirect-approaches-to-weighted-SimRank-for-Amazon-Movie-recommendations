...
class GraphComp:
    ...
    def similarity_check_vector_VAL(self, R, ref_user_idx, user, model_info, validation_info, top_similarity=40):
        ...
        movie_FOR_reference_user = model_info[5]
        ...
        #print('movie_similarity_rate_norm: {}'.format(movie_similarity_rate_norm))
        ...
        #print('user_similarity_top_non_zero={}'.format(user_similarity_top_non_zero))
        for u_idx in user_similarity_top_non_zero:
            user_name = node_list[u_idx]
        ...
        return df_summary, movie_list_ref, movie_FOR_reference_user, user_similarity_top_non_zero, df_movie_similarity
    ...
    def similarity_summary_ratio_VAL(self, df_summary, movie_list_ref, max_connected_gr_amazon_movies, max_connected_gr_amazon_movies_v):
        ...
        if self.debug_mode == 'On':
            ...
            print('\n')
            print('df_summary_ratio: {}'.format(df_summary_ratio))
