...
class Amazon:
    ...
    def run_validation_TOP_N(self, max_connected_gr_amazon_movies, max_connected_gr_amazon_movies_VAL, walk_steps, n_test_users, beta, top_neighbor, top_N_suggestions):
        ...
        print('FOR loop starts in top-N users: {}'.format(datetime.datetime.now()))
        ...
        for i, user in enumerate(test_users):
            ...
            #print('Starting lst_top_movie_suggestions')
            for mv_new in lst_top_movie_suggestions:
                ...
                #print('In lst_top_movie_suggestions')
                ratio_m = 0
                try:
                    #print('In try')
    ...
    def save_performance_values_ALL(self, df_FINAL, time_1, time_2):
        ...
        print('lst_auc: {}'.format(len(lst_auc)))
        print('lst_tpr: {}'.format(len(lst_tpr)))
        print('lst_precision: {}'.format(len(lst_precision)))
        print('lst_fpr: {}'.format(len(lst_fpr)))
        print('lst_thresholds: {}'.format(len(lst_thresholds)))
        print('lst_calc_time: {}'.format(len(lst_calc_time)))
        print('lst_name: {}'.format(len(lst_name)))
        print('lst_value: {}'.format(len(lst_value)))
        print('lst_other_metrics_name: {}'.format(len(lst_other_metrics_name)))
        print('lst_other_metrics_value: {}'.format(len(lst_other_metrics_value)))
